...
frm2.setAttribute('action', 'assigner');
...
document.body.appendChild(iframe2);
    ...
    doc.body.innerHTML = '<table><tr><center><b><u>Task Creator Progress</u></b> (<a href="javascript:parent.closeMe2();">x</a>)</center></tr><tr><td><button type="submit" onClick="return htask(this.form)"><img src="fig/ballBlacks.png" width="30"alt=""></button><button type="submit" onClick="return htask(this.form)"><img src="fig/ballBlacks.png" width="30"alt=""></button><button type="submit" onClick="return htask(this.form)"><img src="fig/ballBlacks.png" width="30"alt=""></button><button type="submit" onClick="return htask(this.form)"><img src="fig/ballBlues.png" width="30"alt=""></button><button type="submit" onClick="return htask(this.form)"><img src="fig/ballWhites.png" width="30"alt=""></button></td></tr><tr><td align=center><a href="javascript:parent.nextTab();">Move on to Next Step \>\></a></td></tr></table>';
