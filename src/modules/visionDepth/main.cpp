 ...
 * \defgroup visionDepth visionDepth
 *
 * \image html visionDepthSim-500px.png
 * 
 * The \ref visionDepth module tracks a red can and streams its location in the format "(x y z) ..." through a
 ...
 * <b>Installation</b>
 *
 * The module is compiled when ENABLE_visionDepth is activated (default: OFF). For further
 ...
 * yarp server &
 *
 * $ASIBOT_DIR/bin/visionDepth
 *
 * <b>Modify</b>
 *
 * This file can be edited at src/modules/visionDepth/main.cpp
 *
 */
